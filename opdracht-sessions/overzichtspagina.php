...
<body>
		...
		<ul>
			...
			<li><?php echo "gemeente: " . $_SESSION['gemeente'] ?> <a name="wijzig" href="adrespagina.php"> Wijzig </a></li>
			<li><?php echo "postcode: " . $_SESSION['postcode'] ?> <a name="wijzig" href="adrespagina.php"> Wijzig </a></li>
		<ul>
</body>
</html>			